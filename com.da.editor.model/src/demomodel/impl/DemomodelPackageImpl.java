...
public class DemomodelPackageImpl extends EPackageImpl implements DemomodelPackage {
	 ...
	 * @see demomodel.DemomodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theDemomodelPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return DemomodelValidator.INSTANCE;
				 }
			 });
	 ...
	 * @generated
	 */
	public EOperation getPerson__HasName__DiagnosticChain_Map() {
	...
	public void createPackageContents() {
		...
		createEOperation(personEClass, PERSON___HAS_NAME__DIAGNOSTICCHAIN_MAP);
	}
