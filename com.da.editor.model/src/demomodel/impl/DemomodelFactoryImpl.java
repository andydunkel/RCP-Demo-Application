...
public class DemomodelFactoryImpl extends EFactoryImpl implements DemomodelFactory {
	...
	public static DemomodelFactory init() {
		try {
			DemomodelFactory theDemomodelFactory = (DemomodelFactory)EPackage.Registry.INSTANCE.getEFactory(DemomodelPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DemomodelPackage.PERSON: return createPerson();
			default:
